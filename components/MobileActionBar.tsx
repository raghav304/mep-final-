...
/**
 * Mobile-only sticky action bar — a proven conversion pattern on contractor
 * sites: one-tap Call and WhatsApp always within reach. Hidden on desktop
 * (xl+), where the floating WhatsApp button is shown instead.
 */
export default function MobileActionBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-2 border-t border-silver/40 bg-white/95 shadow-[0_-8px_24px_-12px_rgba(11,46,91,0.25)] backdrop-blur-md xl:hidden">
      <a
